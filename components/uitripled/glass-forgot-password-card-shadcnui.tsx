...
// import {  } from "react";
import { requestPasswordReset, ResetState } from "@/app/actions/password-reset";

const initialState: ResetState = { success: false };

export default function GlassForgotPasswordCard() {
        ...
        >
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Enter the email associated with your account. We’ll send a magic
